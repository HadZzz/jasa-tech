      ...
      <div className='container px-4 mx-auto'>
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            >
              <strong>Jawatechno</strong> adalah jasa pembuatan website
              terpercaya di Sukoharjo dengan pengalaman 5+ tahun. Kami telah
              membantu 100+ bisnis lokal dengan solusi website modern
              menggunakan teknologi terkini seperti Next.js dan React. Dapatkan
              website berkualitas dengan harga terjangkau mulai Rp 2 juta!
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              ...
              <Image
                src='https://images.unsplash.com/photo-1487014679447-9f8336841d58?auto=format&fit=crop&w=1600&h=900&q=80'
